...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "pasman";
    ...
    public ArrayList<PasManModal> readPassTable() {
        ...
        ArrayList<PasManModal> pasManModals = new ArrayList<>();

        // moving our cursor to first position.
        if (cursorCourses.moveToFirst()) {
            do {
                // on below line we are adding the data from cursor to our array list.
                pasManModals.add(new PasManModal(cursorCourses.getString(1),
        ...
        if (pasManModals.size() < 1){
            pasManModals.add(new PasManModal("No Data",
                    "Found ",
                    "in",
                    "database"));
        }
