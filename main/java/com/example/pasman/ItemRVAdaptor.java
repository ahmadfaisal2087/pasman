...
public class ItemRVAdaptor extends RecyclerView.Adapter<ItemRVAdaptor.ViewHolder> {
    ...
    public ItemRVAdaptor(ArrayList<PasManModal> pasManModals, Context context) {
        this.pasManModals = pasManModals;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        PasManModal modal = pasManModals.get(position);
